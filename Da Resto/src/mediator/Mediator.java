...
public class Mediator {
	...
	public void upgradeSeat() {
		...
		restaurant.reduceGold(restaurant.getUpgradeSeatCost());
		restaurant.upSeat();
	}
	...
	public void upgradeWaiterSpeed(int index) {
		if(restaurant.getGold() < 150) {
			System.out.println("Gold not enough");
			return;
		}
		Waiter waiter = waiterList.get(index);
		if(waiter.getSpeed() >= 5) {
			System.out.println("Max Speed Acquired!");
			return;
		}
		waiter.upgradeSpeed();
		restaurant.reduceGold(150);
	}
	...
	public void upgradeChefSkill(int index) {
		if(restaurant.getGold()< 150) {
			System.out.println("Insufficient Gold");
			return;
		}
		Chef chef = chefList.get(index);
		if(chef.getSkill() >= 5) {
	...
	public void upgradeChefSpeed(int index) {
		if(restaurant.getGold()< 150) {
			System.out.println("Insufficient Gold");
			return;
		}
